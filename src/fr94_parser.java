...
public class fr94_parser {
	...
	public static void main (String args[]) throws IOException
	{
	    ...
	    try {
	      DirectoryStream<Path> directoryStreams = Files.newDirectoryStream(Paths.get("/Users/radheshyamyadav/Desktop/IR_Assignment_2/Assignment_Two/fr94"));
    ...
    for (Element e: docs) {
     	...
     	String PARENT = e.getElementsByTag("PARENT").text();
			...
			File result = new File("/Users/radheshyamyadav/eclipse-workspace/IR_2/FR_DOC/"+DocNo);
